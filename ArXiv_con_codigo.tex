...
\title{Plantilla TyHM basada en \emph{arxiv} style}
...
agencies. Optional.}
  ...
  Mendoza, PA 5502 Argentina \\
  \texttt{\href{mailto:rpalma@uncu.edu.ar}{\nolinkurl{rpalma@uncu.edu.ar}}} \\
   \And
    Gustavo A. Masera
   \\
    Historia del Pensamiento Económico \\
    IMESC - Fac. Filosofía y Letras \\
  Universidad Nacional de Cuyo - Mendoza Argentina \\
  \texttt{\href{mailto:gmasera@gmail.com}{\nolinkurl{gmasera@gmail.com}}} \\
  }
...
\begin{figure}
\centering
\includegraphics{ArXiv_con_codigo_files/figure-latex/fig2-1.pdf}
...
\NormalTok{Titulo}
\NormalTok{\textless{}/head\textgreater{}}
\NormalTok{\textless{}h1\textgreater{} Titulo \textless{}/h1\textgreater{}}
\NormalTok{\textless{}/head\textgreater{}}
\NormalTok{\textless{}/head\textgreater{}}
\end{Highlighting}
\end{Shaded}

Este código es compatible con w3 Consortium Ver: (Consortium et al.
2000) .

Está conformado siguien las regles de paridad da tags. esto quiere decir
que todo tag que se abre, luego se cierra.

\hypertarget{referencias-bibliogruxe1ficas}{%
\section{Referencias
Bibliográficas}\label{referencias-bibliogruxe1ficas}}

Listado de biboiográfía páginas de web y material consultado para este
trabajo.
...
\leavevmode\vadjust pre{\hypertarget{ref-w3extensible}{}}%
Consortium, W3 et al. 2000. {``Extensible Markup Language (Xml) 1.0.''}
\emph{Http://Www.w3.org/TR/1998/REC-Xml-20001006/}.
